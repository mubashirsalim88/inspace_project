...
def fill_step(step):
    ...
    if request.method == "POST" and step != "misc_and_declarations":
        ...
        file_fields = {
            ...
            "launch_and_regulatory": ["dot_license_c ouvrages"],
...
@module_3.route("/download_pdf/<application_id>", methods=["GET"])
@login_required
def download_pdf(application_id):
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as temp_file:
        ...
        story = []
        story.append(Paragraph("Module 3: Non-Indian Satellite Authorization Summary", title_style))
