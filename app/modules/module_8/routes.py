# app/modules/module_8/routes.py
from flask import (
...
@module_8.route("/download_pdf/<int:application_id>", methods=["GET"])
@login_required
def download_pdf(application_id):
    ...
    story = []
    story.append(Paragraph("Module 8: Renewal and Extension Details", title_style))
