...
def download_pdf(application_id):
    ...
    # Fetch uploaded files for Module 1 and Module 5
    ...
    uploaded_file_paths = {}
    for f in uploaded_files_module_1 + uploaded_files_module_5:
    ...
    # Fetch file paths from ModuleData.data for Module 1 and Module 5
    module_data_file_paths = {}
    for md in processed_module_1_data + processed_module_5_data:
    ...
    for md in processed_module_1_data:
        ...
        toc_index += 1
    toc_items.append([f"{toc_index}.", "Module 5: Authorization Details", ""])
    toc_index += 1
    ...
    # Module 5 Section
    story.append(Paragraph(f"{section_index}. Module 5: Authorization Details", heading_style))
    story.append(HRFlowable(width="100%", thickness=0.5, color=colors.gray, spaceBefore=10, spaceAfter=10))
    section_index += 1
    for md in processed_module_5_data:
        section_flowables = []
